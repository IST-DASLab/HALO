    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        kwargs = {
            ...
            "use_hqt": lora_config.use_hqt,
            "hqt_hq_config": lora_config.hqt_hq_config,
            "ephemeral_gpu_offload": lora_config.runtime_config.ephemeral_gpu_offload,
            "loaded_in_8bit": getattr(self.model, "is_loaded_in_8bit", False),  # todo: check this
