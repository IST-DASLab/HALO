...
#export QLORA_ENABLED=false
export HQT_ENABLED=true
...
export RUN_NAME="hqt-${HQT_ENABLED}-r_${LORA_R}-${DATASET}-krn_${KERNEL_TYPE}-seed${SEED}-fwd_hx_${FWD_X_HAD:0:1}-fwd_hw_${FWD_W_HAD:0:1}-bwd1_he_${BWD1_E_HAD:0:1}-bwd1_hw_${BWD1_W_HAD:0:1}-bwd2_he_${BWD2_E_HAD:0:1}-bwd2_hx_${BWD2_X_HAD:0:1}-fwd_qx_${FWD_X_QUANT:0:3}-fwd_qw_${FWD_W_QUANT:0:3}-bwd1_qe_${BWD1_E_QUANT:0:3}-bwd1_qw_${BWD1_W_QUANT:0:3}-bwd2_qe_${BWD2_E_QUANT:0:3}-bwd2_qx_${BWD2_X_QUANT:0:3}-lr${LR}_$RANDOM"
export CONFIG="../configs/hqt_${DATASET}.yaml"
...
composer ../train.py \
    ...
    peft_config.lora.r=${LORA_R} \
    peft_config.lora.alpha=${LORA_ALPHA} \
    peft_config.lora.dropout=${LORA_DROPOUT} \
    peft_config.lora.use_hqt=${HQT_ENABLED}
